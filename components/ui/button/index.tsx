...
const buttonTextStyle = tva({
  ...
  parentVariants: {
    action: {
      primary:
        "text-primary-900 data-[hover=true]:text-primary-900 data-[active=true]:text-primary-700",
      secondary:
        "text-secondary-900 data-[hover=true]:text-secondary-900 data-[active=true]:text-secondary-700",
      positive:
        "text-success-900 data-[hover=true]:text-success-900 data-[active=true]:text-success-700",
      negative:
        "text-error-900 data-[hover=true]:text-error-900 data-[active=true]:text-error-700",
    },
    variant: {
